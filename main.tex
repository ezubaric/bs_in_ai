...
\subsection{Concentration: Generative AI}
  ...
  \input{course_descriptions/Existing}
    ...
    \subsection{Existing, but Need New Prereq Structure}

    \input{course_description/Pre}

  \subsection{Refocus}

    Courses already approved on an experimental basis and whose material perfectly match the goals of \short{}.
...
\input{sections/students_served}
